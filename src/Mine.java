...
public class Mine extends JFrame implements ActionListener, MouseListener{
    ...
    double starttime;
    double endtime;
    public Mine(int M,int N,int Nomines){
    ...
    public void checkifend(){
        ...
        if (check == nomines){
            ...
            Component temporaryLostComponent = null;
            JOptionPane.showMessageDialog(temporaryLostComponent, "Felicidades!!! Ganaste en "+(int)((endtime-starttime)/1000000000)+" segundos!");
            setVisible(false);
        }
    }
